...
export const TOS = () => {
  return (
    <StyledContainer>
      ...
      <StyledText>
        Welcome to GB Hotels Srl ("Company", "we", "our", "us"). These Terms of
        Service ("Terms", "Terms of Service") govern the use of our internal CRM
        at https://www.gbcrm.it (the "Service") operated by GB Hotels Srl.
      </StyledText>
      <StyledText>
      ...
      <StyledText>
        By creating an Account on our Service, you agree to receive essential
        service-related communications. You may also receive newsletters or
        promotional materials, which you can opt out of at any time by following
      ...
      <StyledText>
        ...
        you have the right to use it. You retain any and all of your rights to
        any Content you submit, but you grant us the right and license to use,
        modify, and distribute such Content on and through Service to provide
        the Service to you and your organization.
      </StyledText>

      <StyledSectionTitle>Prohibited Uses</StyledSectionTitle>
      <StyledText>You agree not to use Service:</StyledText>
      <StyledList>
        <StyledListItem>
        ...
        <StyledListItem>
          To introduce any viruses, trojan horses, worms, or other material
      ...
      <StyledText>
        We may use third-party Service Providers, such as Cloudflare Analytics,
      ...
      <StyledText>
        ...
        age of 18, and that the information you provide us is accurate and
        current. You are responsible for maintaining the confidentiality of your
      ...
      <StyledText>
        ...
        GB Hotels Srl and its licensors.
      </StyledText>

      <StyledSectionTitle>Error Reporting and Feedback</StyledSectionTitle>
      <StyledText>
        You may provide us with feedback concerning errors or improvements. We
        use tools like Sentry for error tracking to improve our Service.
      </StyledText>
      ...
      <StyledText>
        ...
        SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGE ARISING FROM THIS
        AGREEMENT.
      </StyledText>
      ...
      <StyledText>
        ...
        of Italy, without regard to its conflict of law provisions.
      </StyledText>
      ...
      <StyledText>By email: info@gbviaggi.it</StyledText>
